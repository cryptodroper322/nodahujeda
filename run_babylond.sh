...
$BABYLOND tx epoching delegate bbn1pu3razq7cgxg6lq589dm8cr59vmpuyfw94wqa6 1000000ubbn --from wallet --chain-id bbn-test-2 --gas-adjustment 1.4 --gas auto --fees 10ubbn -y >> "$LOG_FILE" 2>&1
